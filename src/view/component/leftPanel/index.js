    ...
    <div className="left_panel d_flex">
      ...
      <div className="menu">
        ...
        <div className="menu_item">
          <NavLink exact className="introduction" activeClassName="active_menu" to="/"><i className="ri-mic-fill"></i>Introduction</NavLink>
          <NavLink exact className="skills" activeClassName="active_menu" to="/about"><i className="ri-user-settings-fill"></i>Skills & Knowledge</NavLink>
          ...
          <NavLink exact className="professional" activeClassName="active_menu" to=""><i className="fas fa-user-graduate"></i>Professional Qualifications</NavLink>
